            ...
            <div class="flex flex-col min-h-screen bg-center bg-cover pt-2">
              ...
              >
                <div class="grid gap-2 w-full bg-white rounded-lg p-4">
                  ...
                  <div
                    class="bg-green-700 text-white rounded-2xl shadow-xl py-5 px-3 w-full"
                  >
                    <div class="flex justify-between">
                  ...
                  <div
                    class="bg-yellow-400 text-white rounded-2xl shadow-xl py-5 px-3 w-full"
                  >
                    <div class="flex justify-between">
                  ...
                  >
                    ...
                    <td class="py-4 px-2 rounded-r-lg">
                      <div class="flex justify-between gap-2">
                        ...
                        >
                          <i
                            class="fa-solid fa-circle-check mr-2 -ml-1 w-4 h-4"
                          ></i>
                          Done
                        </button>
                      </div>
...
export default {
  ...
  methods: {
    ...mapActions("transaction", ["getAllTR"]),
    openModal(event) {
      this.value = event;
      this.isOpen = true;
    },
